...
models = classifiers_ex01.keys()
n_models = len(models)

f1_scores = {model: [] for model in models}
auc_scores = {model: [] for model in models}

# Loop through models and collect scores from all files
...
table = tabulate(
    [mean_f1_scores, mean_auc_scores],
    tablefmt="grid",
    headers=models,
...
# Print statistical significance matrices
